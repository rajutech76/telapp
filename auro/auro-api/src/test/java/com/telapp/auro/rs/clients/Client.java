...
public final class Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        System.out.println("client code executing ");
        Client c = new Client();
                
        c.validateUser("jack", "jill");
        

    }
    
    public void validateUser(String userName,String passwd)throws Exception{
    	
    	String url=restUrl+"validateUser/";
    	System.out.println("get request url "+url);
    	 GetMethod get =new GetMethod(url);
    	 setMethodHeaders(get, userName, passwd);
